...
public class AmethystKunaiItem extends Item {
	public AmethystKunaiItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				AmethystKunaiEntity entityarrow = AmethystKunaiEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
